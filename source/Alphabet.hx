    ...
    new FlxTimer().start(0.05, function(tmr:FlxTimer) {
        ...
        || isSymbol) // if (AlphaCharacter.alphabet.contains(splitWords[loopNum].toLowerCase()) || isNumber || isSymbol)
      {
        ...
        if (FlxG.random.bool(40))
        {
		  ...
		  FlxG.sound.play('${AssetPaths.SOUND_FOLDER}/' + daSound + FlxG.random.int(1, 4) + AssetPaths.soundExt, 0.4);
        }
...
class AlphaCharacter extends FlxSprite
{
  ...
  {
    animation.addByPrefix(boldletter, boldletter.toUpperCase() + " bold0", 24);
