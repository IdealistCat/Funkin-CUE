...
class FlxAnimationController implements IFlxDestroyable
{
	 ...
	 */
      ...
      * Internal, stores all the animation that were added to this sprite.
      */
     var _animations_string(default, null):Array<String> = [];
	...
	public function remove(Name:String):Void
	{
		...
		if (anim != null)
		{
            ...
            _animations_string.remove(Name);
			anim.destroy();
		}
	}
	...
	public function getAnimationList():Array<String>
	{
		...
		for (anim in _animations_string)
		{
			animList.push(anim);
		}
	...
	public function rename(oldName:String, newName:String)
	{
        ...
        var _asIDX:Int = _animations_string.indexOf(oldName);
        _animations_string.remove(oldName);
        _animations_string.insert(_asIDX, newName);
