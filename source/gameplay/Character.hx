...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-arrows':
				tex = FlxAtlasFrames.fromSparrow('$assetPath_prefix/GF_assets-arrows.png', '$assetPath_prefix/GF_assets-arrows.xml');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
			...
			case 'bf-dead':
				var tex = FlxAtlasFrames.fromSparrow('$assetPath_prefix/BOYFRIEND_GAMEOVER.png', '$assetPath_prefix/BOYFRIEND_GAMEOVER.xml');
				frames = tex;
